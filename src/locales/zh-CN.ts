export default {
  ...
  model: {
    ...
    autoSize: '自动定标',
    noteLabel: '备注 / 提示',
    notePlaceholder: '输入想对模型的备注或提示描述',
    imageInput: '参考图片',
    uploadPlaceholder: '点击上传图片',
    imageUrlPlaceholder: '或粘贴图片 URL',
    advanced: '高级选项',
    advancedShow: '展开高级选项',
    advancedHide: '收起高级选项',
    actions: {
    ...
    multiviewHint: '请至少上传 2 张视角，正面必选',
    views: {
      front: '正面',
      left: '左侧',
      back: '背面',
    ...
    versionLabel: '模型版本',
    createdAt: '创建时间',
    confirmDelete: '确定删除该模型记录？',
    empty: '暂无模型任务，请先提交生成',
    toast: {
      uploadSuccess: '上传成功',
      imageRequired: '请上传或填写一张参考图',
      multiviewFront: '请至少提供正面视角图片',
      multiviewMin: '多视角任务至少提供 2 张图片',
      submitted: '已提交 Tripo3D 任务',
      noModel: '暂未生成可下载的模型链接',
      copied: '链接已复制',
      refreshed: '任务状态已刷新',
    },
    tips: {
      texture: '贴图：输出彩色纹理，贴合原始图片',
