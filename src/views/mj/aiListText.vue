...
<span class="flex justify-start items-center">
    ...
    <n-avatar v-else-if="myObj.gpts" :src="myObj.gpts.logo" fallback-src="../../assets/avatar.png" :size="18" round/> 
...
<div class="relative flex-1 overflow-hidden break-all text-ellipsis whitespace-nowrap">
    ...
    <n-popover v-else   placement="right-start" trigger="hover">
        ...
        <template v-if="myObj.gpts">
            ...
            <n-avatar :src="myObj.gpts.logo" fallback-src="../../assets/avatar.png" round/> 
